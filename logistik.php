...
<div class="container">
	...
	<br>
	<h3 style="color: white;">Ruangan | Logistik</h3>
	<br>
	<div style="display: flex; justify-content: space-between;">
		<a href = "unduh_excel_logistik.php" class="btn btn-success"><img src="Gambar/file-excel.png"> Unduh Excel</a>
	  ...
	  <div class="modal-dialog modal-xl" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="tambahModalLabel">Form Tambah Data Ruangan Logistik</h5>
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<input type="hidden" name="kode_bagian" id="kode_bagian" value="11" class="form-control" required>
	        </div>
	        <div class="form-group">
