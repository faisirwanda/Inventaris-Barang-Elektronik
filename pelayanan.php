<?php 
    ...
    if(mysqli_num_rows($query) == 0){
    	...
    	echo"<script>alert('Kode perangkat telah digunakan')</script>";
    }
	}
...
<div class="container">
	...
	<br>
	<h3 style="color: white;">Ruangan | Pelayanan</h3>
	<br>
		<a href = "unduh_excel_pelayanan.php" class="btn btn-success"><img src="Gambar/file-excel.png"> Unduh Excel</a>
	  ...
	  <div class="modal-dialog modal-xl" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="tambahModalLabel">Form Tambah Data Ruangan Pelayanan</h5>
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<input type="hidden" name="kode_bagian" id="kode_bagian" value="4" class="form-control" required>
	        </div>
	        <div class="form-group">
