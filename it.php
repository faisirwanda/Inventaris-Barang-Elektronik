...
<div class="container">
	...
	<br>
	<h3 style="color: white;">Ruangan | IT</h3>
	<br>
		<a href = "unduh_excel_it.php" class="btn btn-success"><img src="Gambar/file-excel.png"> Unduh Excel</a>
	    ...
	    <table class="table table-bordered table-striped">
	    	...
	    	<?php
	    		...
	    		while($data = mysqli_fetch_array($hasil)) :
	    			...
	    			$tgl = date("d-m-Y",strtotime($data['tahun_perangkat']));
	    	?>
	    	<tr>
	    		<td><?=$no++?></td>
	  ...
	  <div class="modal-dialog modal-xl" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="tambahModalLabel">Form Tambah Data Ruangan IT</h5>
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<input type="hidden" name="kode_bagian" id="kode_bagian" value="3" class="form-control" required>
	        </div>
	        <div class="form-group">
