...
<div class="container">
	...
	<br>
	<h3 style="color: white;">Ruangan | Sarana</h3>
	<br>
		<a href = "unduh_excel_sarana.php" class="btn btn-success"><img src="Gambar/file-excel.png"> Unduh Excel</a>
	  ...
	  <div class="card-body">
	    <table class="table table-bordered table-striped">
	    	<tr align="center">
		    	...
		    	<th>Status</th>
		    	<th>Keterangan</th>
		    	<th width="125">Terakhir Diubah</th>	
	  ...
	  <div class="modal-dialog modal-xl" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="tambahModalLabel">Form Tambah Data Ruangan Sarana</h5>
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="kode_bagian">Kode Bagian</label><br>
	        	<input type="hidden" name="kode_bagian" id="kode_bagian" value="10" class="form-control" required>
	        </div>
	        <div class="form-group">
