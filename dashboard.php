...
<body style="background-color: orange;">
    ...
    <div class="row mt-4">
        ...
        <div class="card text-white o-hidden h-100" style="background-color:rgba(113, 124, 255, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=kantor_pos"; ?>">
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(219, 55, 55, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=kepala_kantor"; ?>">
                <span class="float-left" >Lihat Detail</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(219, 55, 55, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=sdm"; ?>">
                <span class="float-left">Lihat Detail</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(219, 55, 55, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=it"; ?>">
                <span class="float-left">Lihat Detail</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(227, 191, 0, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=pelayanan"; ?>">
                <span class="float-left">Lihat Detail</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(227, 191, 0, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=customer_service"; ?>">
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(227, 191, 0, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=penjualan"; ?>">
                <span class="float-left">Lihat Detail</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(52, 174, 101, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=akuntansi"; ?>">
                <span class="float-left">Lihat Detail</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(52, 174, 101, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=slpk"; ?>">
                <span class="float-left">Lihat Detail</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(52, 174, 101, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=pengolahan"; ?>">
                <span class="float-left" >Lihat Detail</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(112, 181, 231, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=sarana"; ?>">
                <span class="float-left">Lihat Detail</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(112, 181, 231, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=logistik"; ?>">
                <span class="float-left">Lihat Detail</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white o-hidden h-100" style="background-color:rgba(112, 181, 231, 1); ">
            ...
            <a class="card-footer text-white clearfix small z-1"
                href="<?php echo BASE_URL."index.php?page=kurir"; ?>">
                <span class="float-left">View Details</span>
                <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                </span>
