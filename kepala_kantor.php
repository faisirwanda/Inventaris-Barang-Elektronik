	  ...
	  <div class="modal-dialog modal-xl" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="tambahModalLabel">Form Tambah Data Ruangan Kepala Kantor</h5>
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<input type="hidden" name="kode_bagian" id="kode_bagian" value="1" class="form-control" required>
	        </div>
	        <div class="form-group">
